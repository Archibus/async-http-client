...
public class AsyncHttpClientDefaultsTest {
    ...
    public void testDefaultPooledConnectionIdleTimeout() {
        Assert.assertEquals(AsyncHttpClientConfigDefaults.defaultPooledConnectionIdleTimeout(),
            60 * 1000);
        testIntegerSystemProperty("pooledConnectionIdleTimeout",
            "defaultPooledConnectionIdleTimeout", "100");
    }

    public void testDefaultReadTimeout() {
        Assert.assertEquals(AsyncHttpClientConfigDefaults.defaultReadTimeout(), 180 * 1000);
        testIntegerSystemProperty("readTimeout", "defaultReadTimeout", "100");
    }

    public void testDefaultRequestTimeout() {
        Assert.assertEquals(AsyncHttpClientConfigDefaults.defaultRequestTimeout(), 180 * 1000);
    ...
    public void testDefaultDisableUrlEncodingForBoundRequests() {
        ...
        testBooleanSystemProperty("disableUrlEncodingForBoundRequests",
            "defaultDisableUrlEncodingForBoundRequests", "true");
    }
    ...
    public void testDefaultUseInsecureTrustManager() {
        ...
        testBooleanSystemProperty("useInsecureTrustManager", "defaultUseInsecureTrustManager",
            "false");
    }

    public void testDefaultHashedWheelTimerTickDuration() {
        Assert.assertEquals(AsyncHttpClientConfigDefaults.defaultHashedWheelTimerTickDuration(),
            100);
        testIntegerSystemProperty("hashedWheelTimerTickDuration",
            "defaultHashedWheelTimerTickDuration", "100");
    }
    ...
    private void testIntegerSystemProperty(final String propertyName, final String methodName,
            final String value) {
        final String previous = System.getProperty(ASYNC_CLIENT_CONFIG_ROOT + propertyName);
        System.setProperty(ASYNC_CLIENT_CONFIG_ROOT + propertyName, value);
        AsyncHttpClientConfigHelper.reloadProperties();
        try {
            final Method method = AsyncHttpClientConfigDefaults.class.getMethod(methodName);
    ...
    private void testBooleanSystemProperty(final String propertyName, final String methodName,
            final String value) {
        final String previous = System.getProperty(ASYNC_CLIENT_CONFIG_ROOT + propertyName);
        System.setProperty(ASYNC_CLIENT_CONFIG_ROOT + propertyName, value);
        AsyncHttpClientConfigHelper.reloadProperties();
    ...
    private void testStringSystemProperty(final String propertyName, final String methodName,
            final String value) {
        final String previous = System.getProperty(ASYNC_CLIENT_CONFIG_ROOT + propertyName);
        System.setProperty(ASYNC_CLIENT_CONFIG_ROOT + propertyName, value);
        AsyncHttpClientConfigHelper.reloadProperties();
